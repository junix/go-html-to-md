...
- 读者问题：go-html-to-md 的代码从哪里进入、由哪些分区构成、怎样运行并如何验证？
- 语言：简体中文；代码、路径与命令保留原文
- 媒介：2000 × 3030 静态矢量长图（高度按内容自适应）
...
google-chrome --headless=new --disable-gpu --hide-scrollbars --force-device-scale-factor=1 --window-size=3000,4545 --virtual-time-budget=10000 --screenshot=architecture.png _render-png.html
